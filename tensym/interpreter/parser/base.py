...
class BaseParser(ABC):
    ...
    @property
    def iter_tokens(self) -> Iterable:
        return self.__tokens

    @property
    def current_token(self) -> Token:
        return self.__tokens.current() or Token(TokenType.NONE, None, None)

    def peek(self, n: int, default: any = None) -> Union[Token, None]:
        return self.__tokens.peek(n, default)

    def peek_type(self, n: int) -> TokenType:
