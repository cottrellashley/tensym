...
try:
    ...
    mathematica = None
    logger.warning(
        "Mathematica is not installed. Mathematica backend will not be available."
    )
...
_BACKENDS = {"sympy": sympy, "mathematica": mathematica, "scipy": scipy, "numpy": numpy}


class Backend(Protocol):
    def alloc(
        self, shape: Tuple[int, ...], kind: Literal["object", "numeric"]
    ) -> Any: ...
